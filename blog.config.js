...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'd5428b374bdf422ca7d6cbae82588f11',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wyw2451', // 您的昵称 例如 tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/stoneteach.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
